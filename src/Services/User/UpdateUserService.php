...
class UpdateUserService
{
    ...
    public function __construct($user, $userId = null, ContainerInterface $container)
    {
    ...
    {
        $user = $this->repository->find($this->userId) ?? null;
    ...
    protected function validateEmail(?string $email): string
    {
        ...
        if ($getUserByEmail && $getUserByEmail->getId() !== $this->userId) {
